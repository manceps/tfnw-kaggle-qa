...
if __name__ == '__main__':
    ...
    import tensorflow as tf        # I think this is loading TFv1
...
def compute_f1(answer_stats, prefix=''):
  ...
  # has_gold, has_pred, is_correct, _ = zip(*answer_stats)    (Py2-3)
...
def compute_pr_curves(answer_stats, targets=None):
  ...
  # for threshold, (precision, recall) in scores_to_stats.iteritems():    (Py2-3)
  ...
  return ((best_f1, best_precision, best_recall, best_threshold),
          # zip(targets, max_recall, max_precision, max_scores))   (Py2-3)
...
def get_metrics_with_answer_stats(long_answer_stats, short_answer_stats):
  ...
  def _get_metric_dict(answer_stats, prefix=''):
    ...
    # return dict([(prefix + k, v) for k, v in metrics.iteritems()])   (Py2-3)
